...
const Contact = () => {
  return (
    <div>
        <div className='text-center text-2xl pt-10 bordeer-t'>
        ...
        <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-20'>
             ...
             <div className='flex flex-col justify-center items-start gap-6'>
                 ...
                 <p className='text-gray-500'>Fateh Garh Agency Chownk<br/> Sialkot, Punjab, Pakistan</p>
                 <p className='text-gray-500'>Tel: (415) 555-0132 <br /> Email:halihaider511@gmail.com</p>
